...
import { c as createLucideIcon, l as commonjsGlobal, n as getDefaultExportFromCjs, R as React, r as reactExports, o as useRouterState, u as useNavigate, j as jsxRuntimeExports, a as Layout, O as OutlinedButton, h as LoadingBar } from "./index-Dc4Qvpv5.js";
import { T as TagBadge } from "./TagBadge-BrjC3oSW.js";
import { a as UnderlineInput } from "./UnderlineInput-CkjfvvuA.js";
import { m as useGetJournalEntry, n as useCreateJournalEntry, o as useUpdateJournalEntry, p as useDeleteJournalEntry } from "./useQueries-CW8XzbIE.js";
...
function DeleteConfirm({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "dialog",
    {
      open: true,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] tracking-[0.3em] uppercase text-muted-foreground mb-3", children: "Confirm Deletion" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display italic text-2xl text-foreground mb-2 leading-tight", children: "Delete this entry?" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-muted-foreground mb-8 leading-relaxed", children: "This action is permanent and cannot be undone." }),
...
function JournalDetailPage() {
  ...
  const handleAutoSave = reactExports.useCallback(() => {
    if (isNew || !title.trim() || creating || updating) return;
    const input = {
      title: title.trim(),
      body,
      tags,
      caseRefs: (existing == null ? void 0 : existing.caseRefs) ?? [],
      theoryRefs: (existing == null ? void 0 : existing.theoryRefs) ?? []
    };
    update(
      { id: BigInt(id), input },
      { onSuccess: () => setLastSaved(/* @__PURE__ */ new Date()) }
    );
  }, [isNew, title, body, tags, id, existing, creating, updating, update]);
  reactExports.useEffect(() => {
    if (autoSaveRef.current) clearTimeout(autoSaveRef.current);
    autoSaveRef.current = setTimeout(handleAutoSave, 3e4);
    return () => {
      if (autoSaveRef.current) clearTimeout(autoSaveRef.current);
    };
  }, [handleAutoSave]);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1400px] mx-auto px-6 md:px-10 py-12 md:py-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-10 flex-wrap gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
          lastSaved && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-[10px] tracking-widest uppercase text-muted-foreground flex items-center gap-1.5", children: [
      ...
      isLoading && /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingBar, { className: "mb-8" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto", "data-ocid": "journal-editor", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] tracking-[0.35em] uppercase text-muted-foreground mb-6", children: isNew ? "New Entry — Research Journal" : "Edit Entry" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px bg-border mb-8" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "journal-body", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[10px] tracking-widest uppercase text-muted-foreground mb-3", children: "Body" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            ReactQuill,
            {
              theme: "snow",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px bg-border my-8" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "journal-tags", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            UnderlineInput,
            {
              label: "Tags",
          ...
          tags.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mt-3", children: tags.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              onClick: () => removeTag(t),
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-[9px] text-muted-foreground group-hover:text-destructive transition-colors duration-150", children: "×" })
              ]
            },
            t
          )) })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            OutlinedButton,
            {
              ...
              children: isSaving ? "Saving..." : isNew ? "Create Entry" : "Save Entry"
            }
          )
        ] })
      ] })
